...
import com.example.fileexportjt.R
import com.example.fileexportjt.ui.theme.gray
import com.example.fileexportjt.ui.theme.orange
import com.example.fileexportjt.ui.theme.white
import java.io.File

@Composable
fun ExportScreen(exportViewModel: ExportViewModel = hiltViewModel()) {
        ...
        Column(
            ...
            Button(
                ...
                modifier = Modifier
                    ...
                    .padding(10.dp),
                shape = CircleShape,
                enabled = !fileExportState.isShareDataReady
            ){
                Text(
                    text = "Generate File",
            ...
            AnimatedVisibility(visible = fileExportState.isShareDataReady) {
                IconButton(
                    onClick = {
                        exportViewModel.onShareDataClicked()
                    }
                ){
                    Icon(
